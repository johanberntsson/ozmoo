...
+
	...
	lda #0			; open 15,dev,15 - a normal DOS command channel
	jsr setnam
	lda #15
	ldx #device
	ldy #15
...
m_title   !pet 147,"dos coexistence test",13,0
m_inst    !pet "installed",13,0
m_blocks  !pet "blocks=$",0
m_jiffies !pet "  jiffies=$",0
m_cksum   !pet "  cksum=$",0
m_fail    !pet "open failed",13,0
m_try     !pet "opening dos channel...",13,0
m_opened  !pet "opened, status: ",0
m_survived !pet "SURVIVED - dos still works",13,0
