...
z_temp				  = $16 ; = $68 ; 12 bytes
alphabet_table		  = $22 ; = $96 ; 2 bytes

z_opcode              !byte 0 ; = $02
mempointer            = $24; = $03 ; 2 bytes
...
z_local_vars_ptr      = $28 ; = $26 ; 2 bytes
z_local_var_count	  !byte 0 ;= $28
stack_pushed_bytes	  !byte 0, 0 ;= $29 ; !byte 0, 0
stack_ptr             = $2a ; = $2b ; 2 bytes
stack_top_value 	  !byte 0, 0 ;= $2d ; 2 bytes !byte 0, 0
stack_has_top_value   !byte 0 ;= $2f ; !byte 0
z_pc				  = $2c ; = $30 ; 3 bytes (last byte shared with z_pc_mempointer)
z_pc_mempointer		  = $2f ; = $32 ; 2 bytes (first byte shared with z_pc)
...
; TODO: C128 can only switch out ROM+editor ($c000 - $fff) as a unit, so
; first_banked_memory_page needs to be adjusted. But together with
; basic starting higher this leaves much less memory for dynmem
