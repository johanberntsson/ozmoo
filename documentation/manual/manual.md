...
These source files are located in the asm dictory

| **File** | **Comment** |
| --- | --- |
| ozmoo.asm | this file start starts Ozmoo with the main loop |
| zmachine.asm | implements the main loop of the Z-machine |
| constants.asm | zero page allocations and kernal labels |
| constants-c128.asm | zero page allocations and kernal labels for the C128 |
| constants-header.asm | labels to access the header part of a story file |
| disk.asm | routines that read and write to floppy disk |
